...
define('UTID_PROSECOND',  2);    //二级供应商
define('UTID_PURCHASER',  4);    //采购商

/*公司用户系统*/
define('UTID_ZB',         8);    //公司总部
define('UTID_MANAGER_L1', 16);   //一级代理 收一级代理费--省代
define('UTID_MANAGER_L2', 32);   //二级代理 收二级代理费 --市代
define('UTID_GROWTH',     64);   //发展商    收发展费
define('UTID_SELLER',     128);  //分销商    收销售费
define('UTID_CUSTOMER',   256);  //消费者     查看订单列表
