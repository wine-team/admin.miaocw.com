...
class Mall_attribute_value_model extends CI_Model
{
    ...
    public function insertAttrVal($postData = array())
    {
        $data = array(
            ...
            'attr_values'     => str_replace('，', ',', $postData['attr_values']),
    ...
    public function updateAttrVal($postData = array())
    {
        $data = array(
            'group_id'        => $postData['group_id'],
            'attr_set_id'     => $postData['attr_set_id'],
        ...
        $this->db->where('attr_value_id', $postData['attr_value_id']);
