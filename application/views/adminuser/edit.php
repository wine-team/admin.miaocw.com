        ...
        <div class="span12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-plus-sign"></i>编辑员工</div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <form class="form-horizontal line-form" action="<?php echo base_url('adminuser/editPost') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="controls">
                                <select class="medium m-wrap required" name="role_id">
                                    ...
                                    <?php foreach ($roles->result() as $role) : ?>
                                        <option value="<?php echo $role->id ?>" <?php if ($adminuser->role_id == $role->id) :?>selected="selected"<?php endif;?>><?php echo $role->name ?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                        </div>
