    ...
    <div class="row-fluid inbox">
        <div class="span2">
            <ul class="inbox-nav margin-bottom-10">
                ...
                <li class="draft <?php if($this->uri->segment(3)==$g->group_id) echo 'active';?>"><a data-title="Draft" href="<?php echo base_url('mall_attribute_group/grid/'.$g->group_id.'?attr_set_id='.$attr_set_id);?>" class="btn"><?php echo $g->group_name?></a></li>
                <?php endforeach;?>
            </ul>
        </div>
        <div class="span10">
            <div class="inbox-header">
                <?php foreach($attributeGroup as $g) :?>
                <h1 class="pull-left">
                <?php if($this->uri->segment(3)==$g->group_id) : echo $g->group_name.'（ID：'.$g->group_id.'）';?>
                </h1>
