...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            ...
            <?php echo breadcrumb(array('商品管理', 'mall_attribute_set/grid'=>'商品类型', '添加类型')); ?>
        </div>
    </div>
        ...
        <div class="span12">
            <div class="portlet box green">
                ...
                <div class="portlet-body form">
                    <form class="form-horizontal line-form" action="<?php echo base_url('mall_attribute_set/addPost') ?>" method="post" enctype ="multipart/form-data" >
