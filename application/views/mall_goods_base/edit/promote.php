<div class="control-group ">
    ...
    <div class="controls">
        <input type="text" name="promote_price" value="<?php echo $mallGoodsBase->promote_price ?>" class="m-wrap span12 number">
    </div>
</div>
<div class="control-group ">
    ...
    <div class="controls form-search-time">
        <div class="input-append date form_datetime">
            <input type="text" name="promote_start_date" value="<?php echo $mallGoodsBase->promote_start_date ?>" size="16" class="m-wrap m-ctrl-medium">
...
<div class="control-group ">
    ...
    <div class="controls form-search-time">
        <div class="input-append date form_datetime">
            <input type="text" name="promote_end_date" value="<?php echo $mallGoodsBase->promote_end_date ?>" size="16" class="m-wrap m-ctrl-medium">
            <span class="add-on"><i class="icon-calendar"></i></span>
        </div>
    </div>
</div>
