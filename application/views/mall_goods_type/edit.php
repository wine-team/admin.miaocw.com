        ...
        <div class="span12">
            <div class="portlet box green">
                ...
                <div class="portlet-body form">
                    <form class="form-horizontal line-form" action="<?php echo base_url('mall_goods_type/editPost') ?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="type_id" value="<?php echo $res->type_id;?>" >
                       
                        <div class="control-group">
                            <label class="control-label"><em>* </em>商品类型名称</label>
                            <div class="controls">
                                <input type="text" class="m-wrap large required" name="type_name" value="<?php echo $res->type_name;?>"/> 
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="<?php echo base_url('mall_goods_type/grid') ?>">
