...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            ...
            <?php echo breadcrumb(array('用户管理', 'user/grid'=>'用户账号管理','mall_enshrine/grid'=>'用户收藏')); ?>
        </div>
    </div>
        ...
        <div class="span12">
            <div class="portlet box green">
                ...
                <div class="portlet-body form">
                    <form class="form-horizontal form-search" action="<?php echo base_url('mall_enshrine/grid') ?>" method="get">
                        <div class="row-fluid">
                            <div class="span4">
