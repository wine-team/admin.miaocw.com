	                           ...
	                           <?php foreach ($attribute_value->result() as $item):?>
		                           <div class="control-group ">
			                            ...
			                            <div class="controls <?php if($item->attr_type=='date')echo 'date';?>">
			                                ...
			                                <?php if(!empty($item->attr_values)):?>
			                                <?php $selectValue = explode(',',$item->attr_values)?>
			                                <select data-placeholder="<?php echo $item->attr_name;?>" class="chosen span6 <?php if($item->values_required==1):?>required<?php endif;?>" multiple="multiple" tabindex="6" name="attr[<?php echo $item->group_id?>][<?php echo $item->attr_value_id;?>][]">
