...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            ...
            <?php echo breadcrumb(array('权限菜单管理', 'role/grid'=>'角色管理', '添加角色')); ?>
        </div>
    </div>
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body flip-scroll">
                    <div class="dataTables_wrapper form-inline">
                        <form class="line-form" action="<?php echo base_url('role/addPost') ?>" method="post" enctype="multipart/form-data">
