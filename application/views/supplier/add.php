...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            ...
            <?php echo breadcrumb(array('用户管理', 'supplier/grid'=>'供应商管理', '添加供应商')); ?>
        </div>
    </div>
        ...
        <div class="span12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-plus-sign"></i>添加供应商</div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <form class="form-horizontal line-form supplier-form" action="<?php echo base_url('supplier/addPost') ?>" method="post" enctype ="multipart/form-data" >
                        <div class="control-group add-supplieruid-html">
                            ...
                            <div class="controls">
                                <input type="text" name="uid" value="1" class="m-wrap medium supplieruid tooltips number" data-original-title="双击可弹框选择供应商；直接输入‘用户名称或编号’可提示" data-trigger="hover">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label"><em>* </em>供应商名称</label>
                            <div class="controls">
                                <input type="text" name="supplier_name" class="m-wrap large required"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">供应商简介</label>
                            <div class="controls">
                                <textarea class="textarea-multipart-edit" name="supplier_desc"></textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="radio">
                                	<input type="radio" class="required" name="is_check" value="1"  checked="checked"/> 正常
                                </label>
                                <label class="radio">
                                	<input type="radio" class="required" name="is_check" value="2" />冻结
                                </label>
                            </div>
                        </div>
