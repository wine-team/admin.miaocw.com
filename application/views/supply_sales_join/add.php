...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            ...
            <?php echo breadcrumb(array('商品管理', 'supply_sales_join/grid'=>'品牌管理', '添加品牌')); ?>
        </div>
    </div>
        ...
        <div class="span12">
            <div class="portlet box green">
                ...
                <div class="portlet-body form">
                    <form class="form-horizontal line-form" action="<?php echo base_url('supply_sales_join/addPost') ?>" method="post" enctype ="multipart/form-data" >
