                ...
                <div class="portlet-body form">
                    <form class="form-horizontal line-form" action="<?php echo base_url('user_coupon_get/editPost') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-append date date-picker" data-date-format="yyyy-mm-dd">
                                    <input type="text" name="start_time" value="<?php echo $userCouponGet->start_time ?>" size="16" class="m-wrap date-picker" readonly="readonly">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-append date date-picker" data-date-format="yyyy-mm-dd">
                                    <input type="text" name="end_time" value="<?php echo $userCouponGet->end_time ?>" size="16" class="m-wrap date-picker" readonly="readonly">
                                    <span class="add-on"><i class="icon-calendar"></i></span>
                                </div>
                            </div>
                        </div>
