...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            <h3 class="page-title">财务管理 <small>虚拟充值</small><small>虚拟充值记录</small></h3>
            <?php echo breadcrumb(array('财务管理', 'useraccount/index'=>'虚拟充值', 'useraccount/historyrecharge'=>'虚拟充值记录')); ?>
        </div>
    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $item->user_name;?>/<?php echo $item->alias_name;?></td>
